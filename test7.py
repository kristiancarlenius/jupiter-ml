...
X_scaled = scaler.fit_transform(ais_train[features])
...
# Check the shapes
print(f"X_train shape: {X_train.shape}")  # Expected shape: (num_sequences, sequence_length, num_features)
print(f"y_train shape: {y_train.shape}")  # Expected shape: (num_sequences, 2) for longitude and latitude
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(2)  # Predicting longitude and latitude
])
